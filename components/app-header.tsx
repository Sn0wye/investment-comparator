...
export default function AppHeader({
  ...
  return (
    <header className='border-b border-neutral-200 dark:border-neutral-800 py-4 px-4 mb-6'>
      <div className='container mx-auto flex flex-col sm:flex-row justify-between items-center gap-4'>
        ...
        <div className='flex items-center gap-4'>
          <div className='flex items-center gap-2 bg-neutral-100 dark:bg-neutral-900 px-4 py-2 rounded-md border border-neutral-200 dark:border-neutral-800'>
            ...
            {editingCdi ? (
              <div className='flex items-center'>
                <Input
                  ...
                  className='w-20 h-8 text-right border-neutral-200 dark:border-neutral-700'
                  step='0.01'
                  min='0.01'
                />
