...
export default function AddInvestmentForm({ onAdd, onCancel, cdiRate }: AddInvestmentFormProps) {
  ...
  const [dateInputValue, setDateInputValue] = useState(format(defaultEndDate, "dd/MM/yyyy"))
    ...
    <Card className="w-full max-w-2xl mx-auto border-neutral-800">
      <form onSubmit={handleSubmit}>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="LCI" id="lci" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                step="any"
                required
                className={cn("border-neutral-700 focus:border-neutral-500", amountError && "border-red-500")}
              />
              ...
              <div className="flex gap-2">
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    <Button variant={"outline"} className="border-neutral-700 hover:border-neutral-500" type="button">
          ...
          <div className="space-y-2">
            <Label htmlFor="rate">
              {investment.isPercentOfCDI ? `Taxa (% do CDI atual de ${cdiRate.toFixed(2)}%)` : "Taxa (% ao ano)"}
            </Label>
            <Input
              id="rate"
              type="number"
              value={investment.rate}
              onChange={(e) => handleChange("rate", Number.parseFloat(e.target.value))}
              min="0.01"
              step="0.01"
              required
              className="border-neutral-700 focus:border-neutral-500"
          ...
          {investment.type === "CDB" && (
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <span className="text-sm text-muted-foreground">Calculado automaticamente pela duração</span>
              </div>
              <Input
                id="ir"
                type="number"
              ...
              <p className="text-xs text-muted-foreground">
                Até 6 meses: 22,5%, Até 12 meses: 20%, Até 24 meses: 17,5%, Acima de 24 meses: 15%
              </p>
            </div>
          )}
        </CardContent>
