...
export default function InvestmentCard({
  ...
  const { grossValue, liquidValue, grossReturn, liquidReturn, months } =
    calculateInvestmentReturns(investment, cdiRate);
  ...
  return (
    <Card className='relative border-neutral-200 dark:border-neutral-800'>
      ...
      <CardContent className='space-y-4'>
        ...
        <div className='grid grid-cols-2 gap-4'>
          <div>
            ...
            <p className='font-medium'>
              {investment.rate}%{' '}
              {investment.isPercentOfCDI ? 'do CDI' : 'ao ano'}
            </p>
          </div>
          <div>
      ...
      <CardFooter className='flex flex-col items-stretch border-t border-neutral-200 dark:border-neutral-800 pt-4'>
        <div className='grid grid-cols-2 gap-4 mb-2'>
          <div>
            ...
            <p className='font-medium text-green-600 dark:text-green-500'>
              R${' '}
              {grossReturn.toLocaleString('pt-BR', {
                minimumFractionDigits: 2
              })}
            </p>
          </div>
          <div>
            ...
            <p className='font-medium text-green-600 dark:text-green-500'>
              R${' '}
              {liquidReturn.toLocaleString('pt-BR', {
                minimumFractionDigits: 2
              })}
            </p>
          </div>
        ...
        <div className='grid grid-cols-2 gap-4'>
          <div>
            ...
            <p className='font-semibold'>
              R${' '}
              {grossValue.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}
            </p>
          </div>
          <div>
            ...
            <p className='font-semibold'>
              R${' '}
              {liquidValue.toLocaleString('pt-BR', {
                minimumFractionDigits: 2
              })}
            </p>
          </div>
