...
export function calculateInvestmentReturns(investment: Investment, cdiRate: number): InvestmentReturns {
  ...
  const taxAmount = investment.type === "LCI" ? 0 : grossReturn * (investment.ir / 100)
